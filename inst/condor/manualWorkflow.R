install.packages(c("EGRETci","usgsEGRET","smwrGraphs","reshape2","smwrQW","sbtools"),
...
plotFluxHist(eList, USGSstyle = TRUE, logScale = TRUE,legend = FALSE, yearStart = yearPoints[1],yearEnd = yearPoints[length(yearPoints)]+1)
graphics.off()

setPDF("plotConcHist", layout = list(height=4, width=4, fin=c(3.4,3.4)))
plotConcHist(eList, USGSstyle = TRUE, logScale = TRUE,legend = FALSE, yearStart = yearPoints[1],yearEnd = yearPoints[length(yearPoints)]+1)
graphics.off()

setPDF("plotQTimeDaily", layout = list(height=4, width=4, fin=c(3.4,3.4)))
plotQTimeDaily(eList, USGSstyle = TRUE, logScale = TRUE,legend = FALSE, yearStart = yearPoints[1],yearEnd = yearPoints[length(yearPoints)]+1)
graphics.off()
...
filesWeWant <- c("CIAnnualResults.rds","CIAnnualResults.csv")
zip(zipfile="trends.zip", files=filesWeWant)
